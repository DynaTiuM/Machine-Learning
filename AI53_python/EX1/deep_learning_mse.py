...
print(f"Réseau de neurones - MSE sur l'ensemble d'entraînement : {train_mse_nn:.2f}")
print(f"Réseau de neurones - MSE sur l'ensemble de test : {test_mse_nn:.2f}")
